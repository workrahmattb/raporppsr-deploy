        ...
        @if($kelas)
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Class Info -->
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900 mb-2">Informasi Kelas</h2>
            ...
            @else
                <div class="bg-white rounded-lg shadow-sm p-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Silakan pilih semester untuk melihat leger kelas.</p>
                </div>
            @endif
        @endif
    </div>
