<div>
    ...
    <div class="mb-6">
        <div class="flex items-center mb-4">
            <a href="{{ route('admin.siswa.index') }}" class="text-gray-600 hover:text-gray-900 mr-4">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form wire:submit="save">
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.siswa.index') }}" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg transition">
                    Batal
                </a>
