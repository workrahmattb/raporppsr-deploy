<div>
    ...
    <div class="mb-6">
        <div class="flex items-center mb-4">
            <a href="{{ route('admin.tahun-ajaran.index') }}" class="text-gray-600 hover:text-gray-900 mr-4">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Buat tahun ajaran baru</p>
            </div>
        </div>
    </div>
        ...
        <form wire:submit="save">
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input wire:model="create_semesters" type="checkbox" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    <span class="ml-2 text-sm text-gray-700">Buat semester otomatis (Ganjil & Genap)</span>
                </label>
                <p class="mt-1 text-xs text-gray-500">Sistem akan membuat 2 semester secara otomatis dengan pembagian periode yang sama</p>
            </div>

            <!-- Actions -->
            <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.tahun-ajaran.index') }}" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg transition">
                    Batal
                </a>
