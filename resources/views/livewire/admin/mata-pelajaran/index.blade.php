                ...
                <form wire:submit="save">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model="kelompokForm" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('kelompokForm') border-red-500 @enderror">
                                <option value="A">Kelompok A - Umum</option>
                                <option value="B">Kelompok B - Agama</option>
                                <option value="C">Kelompok C - Muatan Lokal</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select wire:model="tingkatForm" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('tingkatForm') border-red-500 @enderror">
