    ...
    <div class="mb-6">
        <div class="flex items-center mb-4">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Assign guru untuk mengajar mata pelajaran di tingkat tertentu</p>
            </div>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tingkats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-sm text-blue-800">
                            ...
                            <ul class="mt-1 list-disc list-inside space-y-1">
                                <li>Pilih guru yang akan mengajar</li>
                                <li>Pilih mata pelajaran yang akan diajarkan</li>
                                <li>Pilih tingkat kelas (guru akan mengajar di semua kelas pada tingkat tersebut)</li>
                                <li>Satu guru bisa mengajar beberapa mata pelajaran di beberapa tingkat</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /Users/rahmattanri/Documents/Project Code/raporppsr-deploy/resources/views/livewire/admin/penugasan-guru/create.blade.php ENDPATH**/ ?>