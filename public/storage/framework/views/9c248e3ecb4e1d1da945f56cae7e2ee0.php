        ...
        <div class="relative w-full max-w-md px-6 py-8">
            ...
            <div class="text-center mb-8">
                <div class="mx-auto h-24 w-24 bg-white rounded-full flex items-center justify-center mb-4 shadow-lg border-4 border-[#dcb000]">
                    <img src="<?php echo e(asset('img/logo-ppsr.png')); ?>" alt="Logo PPSR" class="h-16 w-auto">
                </div>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="text" name="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="font-medium text-[#006025] hover:text-[#004d1e] hover:underline transition">
                                Lupa password?
                            </a>
            ...
            <div class="mt-8 text-center">
                <p class="text-white/80 text-xs">
                    © <?php echo e(date('Y')); ?> Pondok Pesantren Syafa'aturrasul.<br>All rights reserved.
                </p>
            </div>
        </div>
    </div>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH /Users/rahmattanri/Documents/Project Code/raporppsr-deploy/resources/views/pages/auth/login.blade.php ENDPATH**/ ?>