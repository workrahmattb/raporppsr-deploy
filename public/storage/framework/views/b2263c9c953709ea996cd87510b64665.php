<div>
    ...
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('admin.mata-pelajaran.create')); ?>" wire:navigate class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition">
