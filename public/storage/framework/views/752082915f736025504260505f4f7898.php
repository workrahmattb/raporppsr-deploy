        ...
        document.addEventListener('click', function(event) {
            ...
            if (dropdownContainer && searchInput) {
                ...
                if (!isClickInside && !isInput) {
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('showDropdown', false);
                }
            }
        });
    </script>
        ...
        <form wire:submit="addSiswa">
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="relative" id="searchable-dropdown-container">
                    ...
                    <!-- Input Field -->
                    <div class="relative">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedSiswa || $siswaId): ?>
                            ...
                            <div class="w-full px-4 py-2 bg-green-50 border border-green-300 rounded-lg text-green-900 font-medium">
                                <?php echo e($selectedSiswa['nama'] ?? ($siswaId ? \App\Models\SiswaRapor::find($siswaId)?->nama : '')); ?>
                        ...
                        <?php else: ?>
                            ...
                            <input
                                ...
                                type="text"
                                id="searchSiswa"
                                class="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['siswaId'];
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['siswaId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDropdown): ?>
                        <div class="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-80 overflow-y-auto">
                            ...
                            <!-- Hasil Pencarian -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->availableSiswas->count() > 0): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->availableSiswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <button
                                        type="button"
                                        wire:click="selectSiswa(<?php echo e($siswa->id); ?>, '<?php echo e(addslashes($siswa->nama)); ?>')"
                                    ...
                                    >
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-500">NISN: <?php echo e($siswa->nisn ?? '-'); ?></div>
                                        </div>
                                ...
                                <!-- Pagination -->
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->availableSiswas->hasPages()): ?>
                                    <div class="border-t border-gray-200 px-4 py-3 bg-gray-50">
                                        <div class="flex justify-between items-center">
                                            <span class="text-sm text-gray-600">
                                                Halaman <?php echo e($this->availableSiswas->currentPage()); ?> dari <?php echo e($this->availableSiswas->lastPage()); ?>

                                            </span>
                                            <div class="flex space-x-2">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->availableSiswas->onFirstPage()): ?>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->availableSiswas->hasMorePages()): ?>
                                                    <button
                                                        type="button"
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <span class="ml-2 text-green-900"><?php echo e($selectedSiswa['nama'] ?? ($siswaId ? \App\Models\SiswaRapor::find($siswaId)?->nama : '')); ?></span>
                            </div>
                        </div>
                        <button
                            type="button"
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">
                KELAS
                <span class="text-blue-600"><?php echo e($kelas->nama); ?></span>
                <span class="text-gray-500 font-normal ml-2">(<?php echo e($siswasDiKelas->total()); ?> siswa)</span>
            </h2>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($siswasDiKelas) > 0): ?>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $siswasDiKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($siswasDiKelas->firstItem() + $index); ?>
                                ...
                                <td class="px-6 py-4">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($editingNamaArabic[$siswa->id]) && $editingNamaArabic[$siswa->id]): ?>
                                        <div class="flex items-center space-x-2">
                                            <input 
                                                wire:model="namaArabicValues.<?php echo e($siswa->id); ?>" 
                                                type="text" 
                                                ...
                                                wire:keydown.enter="updateNamaArabic(<?php echo e($siswa->id); ?>)"
                                                wire:keydown.escape="cancelEditNamaArabic(<?php echo e($siswa->id); ?>)"
                                            >
                                            <button 
                                                wire:click="updateNamaArabic(<?php echo e($siswa->id); ?>)" 
                                            ...
                                            <button 
                                                wire:click="cancelEditNamaArabic(<?php echo e($siswa->id); ?>)" 
                                    ...
                                    <?php else: ?>
                                        <div class="flex items-center justify-between group">
                                            <span class="text-sm text-gray-900"><?php echo e($siswa->nama_arabic ?? '-'); ?></span>
                                            <button 
                                                wire:click="editNamaArabic(<?php echo e($siswa->id); ?>, '<?php echo e($siswa->nama_arabic); ?>')" 
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-3">
                                        <a href="<?php echo e(route('admin.siswa.view', $siswa->id)); ?>" wire:navigate class="text-blue-600 hover:text-blue-900 inline-flex items-center">
                                        ...
                                        <button wire:click="confirmDelete(<?php echo e($siswa->id); ?>)" class="text-red-600 hover:text-red-900 inline-flex items-center">
                                            <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Pagination -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($siswasDiKelas->hasPages()): ?>
                <div class="px-6 py-4 border-t border-gray-200">
                    <?php echo e($siswasDiKelas->links()); ?>
...
<?php /**PATH /Users/rahmattanri/Documents/Project Code/raporppsr-deploy/resources/views/livewire/admin/kelas/manage-siswa.blade.php ENDPATH**/ ?>