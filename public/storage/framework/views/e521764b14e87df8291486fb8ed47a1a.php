<div>
    ...
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('admin.siswa.create')); ?>" wire:navigate class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full <?php echo e($siswa->jenis_kelamin == 'L' ? 'bg-blue-100 text-blue-600' : 'bg-pink-100 text-pink-600'); ?>">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-sm text-gray-500"><?php echo e($siswa->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan'); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900"><?php echo e($siswa->nisn); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($siswa->nis ?? '-'); ?></div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900"><?php echo e($siswa->telepon ?? '-'); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($siswa->email ?? '-'); ?></div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900"><?php echo e($siswa->tempat_lahir ?? '-'); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($siswa->tanggal_lahir ? \Carbon\Carbon::parse($siswa->tanggal_lahir)->translatedFormat('d F Y') : '-'); ?></div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900"><?php echo e($siswa->nama_ayah ?? '-'); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($siswa->nama_ibu ?? '-'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                <?php echo e($siswa->status == 'Aktif' ? 'bg-green-100 text-green-800' : ''); ?>

                                <?php echo e($siswa->status == 'Tidak Aktif' ? 'bg-red-100 text-red-800' : ''); ?>

                                <?php echo e($siswa->status == 'Lulus' ? 'bg-blue-100 text-blue-800' : ''); ?>

                                <?php echo e($siswa->status == 'Pindah' ? 'bg-yellow-100 text-yellow-800' : ''); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-3">
                                <a href="<?php echo e(route('admin.siswa.view', $siswa->id)); ?>" wire:navigate class="text-gray-600 hover:text-gray-900 inline-flex items-center">
                                ...
                                <a href="<?php echo e(route('admin.siswa.edit', $siswa->id)); ?>" wire:navigate class="text-blue-600 hover:text-blue-900 inline-flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH /Users/rahmattanri/Documents/Project Code/raporppsr-deploy/resources/views/livewire/admin/siswa/index.blade.php ENDPATH**/ ?>